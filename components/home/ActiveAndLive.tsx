// components/home/ActiveAndLive.tsx
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
      ...
      <div className="p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-sm font-medium text-gray-500">{t("activeBuses")}</h3>
          <Bus className="w-5 h-5 text-indigo-500" />
        </div>
        <h2 className="text-4xl font-bold text-gray-900 mb-4">45</h2>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-gray-500">{t("onRoad")}</span>
      ...
      <div className="p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-sm font-medium text-gray-500">{t("activeRoutes")}</h3>
          <Map className="w-5 h-5 text-blue-500" />
        </div>
        <h2 className="text-4xl font-bold text-gray-900 mb-4">15</h2>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-gray-500">{t("highDemand")}</span>
            <span className="font-semibold text-red-500">5</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-gray-500">{t("normal")}</span>
