...
export const AuthLayoutSide = () => {
  ...
  return (
    <div className="hidden lg:block relative w-0 flex-1 bg-gray-900 overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-br from-indigo-900 to-gray-900 flex flex-col justify-center items-center text-white p-12">
        {/* Abstract Pattern */}
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">{t('secureAccountTitle')}</h2>
